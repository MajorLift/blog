...
I now think of the notes as the checklist and the hook as the trigger that runs the checklist. The two hooks I use daily are public, with their test suites, at [agent-guardrails](https://github.com/MajorLift/agent-guardrails).
