...
*The two-edge condition, and the argument for why the bearing leg cannot be drafted, are developed in [a working paper](https://jongsun.dev/papers/grounds-frames-standing/).*
